...
3. **RAG evaluation**: Create a test set of queries and hand-ground truth answers to evaluate the RAG pipeline's accuracy and relevance using metrics like F1 score, etc.
